...
import nexgen.automation.framework.connectionRepo.MySqlConnection;
//import nexgen.automation.pageclasses.pages.LoginPage;

@Listeners(ListenerTest.class)
public class ValidateMySqlConnectionTest extends BaseSuite{
	
	String connection = System.getProperty("user.dir") + "/src/main/resources/testdata/Connections/MySql.xlsx";
	...
	public void VerifycreateMysqlConnection() throws Exception
	{
		...
		MySqlConnection mysql = new MySqlConnection(driver);
		...
		for (int rowNum = 0; rowNum < rowCount; rowNum++) {
			...
			mysql.createMysqlConnection(driver,output.get(1),output.get(10),output.get(2),output.get(3),output.get(4),output.get(5),output.get(6),output.get(7),
	...
	public void VerifyupdateMysqlConnection() throws Exception {
		...
		for (int rowNum = 0; rowNum < rowCount; rowNum++) {
			...
			List<String> output = XlReader.getDetails(inputs, rowNumber, "Create-Connection", XlReader, connection);
			mysql.updateMySqlConnection(driver, output.get(1),output.get(15),output.get(6), output.get(2), output.get(3),
	...
	public void VerifymySqlConnectionMandatory() throws Exception {
		...
		test = extent.createTest("MySql_Mandatory");
		...
		for (int rowNum = 0; rowNum < rowCount; rowNum++) {
			...
			mysql.mySqlMandatoryField(soft, output.get(0), output.get(1), output.get(2), output.get(3), output.get(4),
