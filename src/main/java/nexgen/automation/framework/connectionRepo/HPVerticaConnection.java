...
public class HPVerticaConnection extends ConnectionUtil {
	
	WebDriver driver;
	
	public HPVerticaConnection(WebDriver driver)
	{
		super(driver);
	}
	
	public void createHPVerticaConnection(WebDriver driver,String connectionName, String ConnectionType,String host, String port,
	...
	public void updateHPVerticaConnection(WebDriver driver,String connectionName,String updatedConnectionName, String fullUrl, String host, String port, String serviceDBName,
	...
	public void HPVerticaMandatoryField(SoftAssert soft, String connectionType, String connFormat,
