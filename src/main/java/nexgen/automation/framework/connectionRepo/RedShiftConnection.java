...
public class RedShiftConnection extends ConnectionUtil {
	
	WebDriver driver;
	
	public RedShiftConnection(WebDriver driver)
	{
		super(driver);
	}
	
	public void createRedshiftConnection(WebDriver driver,String connectionName, String ConnectionType,String host, String port,
	...
	public void updateRedshiftConnection(WebDriver driver,String connectionName,String updatedConnectionName, String fullUrl, String host, String port, String serviceDBName,
	...
	public void RedshiftMandatoryField(SoftAssert soft, String connectionType, String connFormat,
