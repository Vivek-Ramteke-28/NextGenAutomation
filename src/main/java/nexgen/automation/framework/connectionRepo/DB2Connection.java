...
public class DB2Connection extends ConnectionUtil {
	
	WebDriver driver;
	
	public DB2Connection(WebDriver driver)
	{
		super(driver);
	}
	
	public void createDB2Connection(WebDriver driver,String connectionName, String ConnectionType,String host, String port,
	...
	public void updateDB2Connection(WebDriver driver,String connectionName,String updatedConnectionName, String fullUrl, String host, String port, String serviceDBName,
	...
	public void DB2MandatoryField(SoftAssert soft, String connectionType, String connFormat,
