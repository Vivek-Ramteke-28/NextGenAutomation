...
public class MySqlConnection extends ConnectionUtil {
	...
	public MySqlConnection(WebDriver driver)
	{
		super(driver);
	}
	
	public void createMysqlConnection(WebDriver driver,String connectionName, String ConnectionType,String host, String port,
	...
	public void updateMySqlConnection(WebDriver driver,String connectionName,String updatedConnectionName, String fullUrl, String host, String port, String serviceDBName,
	...
	public void mySqlMandatoryField(SoftAssert soft, String connectionType, String connFormat,
