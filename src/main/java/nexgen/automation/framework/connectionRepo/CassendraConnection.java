...
public class CassendraConnection extends ConnectionUtil {
	
	WebDriver driver;
	
	public CassendraConnection(WebDriver driver)
	{
		super(driver);
	}
	
	public void createCassendraConnection(WebDriver driver,String connectionName,String driverName, String ConnectionType,String host, String port,
			...
			String sheetName,String methodName,ExtentTest test, Logger log,String connectionSaveMess) throws Exception
	{
		...
		try {
			...
			BaseSuite.validationReportLog("Connection type is getting display after click on new connection Button");
			Thread.sleep(3000);
			clickOnConnectionName(ConnectionType);
			
			CreateCassendraConnection(driver,connectionName,driverName,host, port, serviceDBName,JDBCUrl,
	...
	public void updateCassendraConnection(WebDriver driver,String connectionName,String updatedConnectionName, String fullUrl, String host, String port, String serviceDBName,
	...
	public void CassendraMandatoryField(SoftAssert soft, String connectionType, String connFormat,
