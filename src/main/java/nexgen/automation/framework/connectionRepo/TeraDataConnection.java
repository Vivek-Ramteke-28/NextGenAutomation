...
public class TeraDataConnection extends ConnectionUtil {
	
	WebDriver driver;
	
	public TeraDataConnection(WebDriver driver)
	{
		super(driver);
	}
	
	public void createTeradataConnection(WebDriver driver,String connectionName, String ConnectionType,String host, String port,
	...
	public void updateTeradataConnection(WebDriver driver,String connectionName,String updatedConnectionName, String fullUrl, String host, String port, String serviceDBName,
	...
	public void TeradataMandatoryField(SoftAssert soft, String connectionType, String connFormat,
