...
public class NetezzaConnection extends ConnectionUtil {
	
	WebDriver driver;
	
	public NetezzaConnection(WebDriver driver)
	{
		super(driver);
	}
	
	public void createNetezzaConnection(WebDriver driver,String connectionName, String ConnectionType,String host, String port,
	...
	public void updateNetezzaConnection(WebDriver driver,String connectionName,String updatedConnectionName, String fullUrl, String host, String port, String serviceDBName,
	...
	public void NetezzaMandatoryField(SoftAssert soft, String connectionType, String connFormat,
