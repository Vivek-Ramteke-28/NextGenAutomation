...
public class PostgresConnection extends ConnectionUtil {
	
	WebDriver driver;
	
	public PostgresConnection(WebDriver driver)
	{
		super(driver);
	}
	
	public void createPostgresConnection(WebDriver driver,String connectionName, String ConnectionType,String host, String port,
	...
	public void updatePostgresConnection(WebDriver driver,String connectionName,String updatedConnectionName, String fullUrl, String host, String port, String serviceDBName,
	...
	public void PostgresMandatoryField(SoftAssert soft, String connectionType, String connFormat,
